...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context1 = new ClassPathXmlApplicationContext("refrence.xml");
		Forest f=(Forest)context1.getBean("forest");
		
		ApplicationContext context2 = new ClassPathXmlApplicationContext("refrence.xml");
